...
test('main test', () => {
	expect(parseCerkeOnlineKia1Ak1(case1)).toEqual({
		...
		parsed_bodies: [
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["AI", "M"], "dest": ["Y", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 5, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "P"], "step": ["I", "P"], "dest": ["U", "P"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "P"], "step": ["AU", "C"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["A", "Z"], "dest": ["E", "Z"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "M"], "step": ["I", "M"], "dest": ["A", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": false } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "C"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "C"], "step": ["A", "C"], "dest": ["A", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 5 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "L"], "step": ["AI", "L"], "dest": ["Y", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "T"], "step": ["I", "N"], "dest": ["U", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "L"], "step": ["I", "L"], "dest": ["E", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "K"], "step": ["E", "K"], "dest": ["E", "L"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 1, "prof": 2 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["AI", "M"], "dest": ["Y", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "Z"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "X"], "step": ["AI", "C"], "dest": ["Y", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 4 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "M"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "K"], "step": ["AI", "K"], "dest": ["Y", "K"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "Z"], "step": ["E", "Z"], "dest": ["A", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 9 } } },
			{ "type": "taxot", "hands": ["王", "獣"], "score": 8 },
			{ "type": "end_season" },
			{ "type": "season_ends", "season": 1 },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["AI", "M"], "dest": ["Y", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "M"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "C"], "dest": ["AU", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "Z"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "P"], "step": ["AU", "C"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["A", "Z"], "dest": ["E", "Z"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "C"], "step": ["A", "C"], "dest": ["A", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 8 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "P"], "step": ["AI", "P"], "dest": ["Y", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["E", "P"], "dest": ["E", "Z"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "P"], "step": ["I", "P"], "dest": ["A", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 6 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "L"], "step": ["AI", "L"], "dest": ["Y", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "L"], "step": ["I", "L"], "dest": ["U", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "T"], "step": ["AI", "Z"], "dest": ["Y", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "T"], "step": ["O", "N"], "dest": ["U", "L"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 0, "prof": 1 } } },
	...
	expect(parseCerkeOnlineKia1Ak1(case2)).toEqual({
		...
		parsed_bodies: [
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "L"], "step": ["AU", "T"], "dest": ["AU", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "L"], "step": ["I", "L"], "dest": ["U", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "T"], "step": ["AI", "N"], "dest": ["Y", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "Z"], "dest": ["U", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["AU", "X"], "dest": ["AU", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": false } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["U", "T"], "step": ["Y", "L"], "dest": ["AI", "N"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 1, "prof": 1 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "K"], "step": ["AI", "K"], "dest": ["AI", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 4 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "M"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "N"], "step": ["A", "N"], "dest": ["A", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 5 } } },
			{ "type": "taxot", "hands": ["同色獣"], "score": 5 },
			{ "type": "end_season" },
			{ "type": "season_ends", "season": 0 },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "P"], "step": ["AI", "P"], "dest": ["Y", "P"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "Z"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "Z"], "step": ["IA", "T"], "dest": ["AU", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["IA", "M"], "dest": ["IA", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "N"], "step": ["AI", "N"], "dest": ["Y", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["I", "T"], "dest": ["U", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "T"], "step": ["AI", "T"], "dest": ["AU", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "T"], "step": ["E", "T"], "dest": ["I", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "N"], "step": ["AI", "L"], "dest": ["Y", "L"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "X"], "step": ["A", "Z"], "dest": ["A", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "M"], "step": ["AI", "X"], "dest": ["O", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "Z"], "step": ["E", "T"], "dest": ["E", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "X"], "step": ["AI", "Z"], "dest": ["Y", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["U", "T"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 1 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "X"], "step": ["AI", "Z"], "dest": ["Y", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["U", "T"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "T"], "step": ["Y", "T"], "dest": ["O", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 1 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["U", "T"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "K"], "dest": ["Y", "K"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["U", "T"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 4 }, "piece_capture": { "color": 1, "prof": 9 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "K"], "step": ["E", "N"], "dest": ["I", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "C"], "step": ["AI", "X"], "dest": ["Y", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["IA", "N"], "dest": ["IA", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 5 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "Z"], "step": ["AU", "X"], "dest": ["AI", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 3 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "Z"], "step": ["AU", "X"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "C"], "dest": ["AU", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["I", "N"], "dest": ["E", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "N"], "step": ["AI", "N"], "dest": ["O", "K"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "K"], "step": ["E", "N"], "dest": ["I", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["O", "K"], "step": ["I", "K"], "dest": ["I", "N"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 0, "prof": 7 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "M"], "step": ["AI", "M"], "dest": ["O", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 5, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "C"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "P"], "step": ["AU", "C"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "tam_move", "movement": { "type": "TamMove", "stepStyle": "StepsDuringLatter", "src": ["O", "Z"], "firstDest": ["U", "Z"], "step": ["I", "Z"], "secondDest": ["E", "Z"] } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "T"], "step": ["AU", "Z"], "dest": ["AI", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 4 }, "piece_capture": { "color": 0, "prof": 0 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["U", "L"], "step": ["U", "M"], "dest": ["O", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "C"], "dest": ["AU", "M"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["E", "M"], "dest": ["E", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "Z"], "step": ["AU", "X"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["O", "M"], "step": ["AI", "M"], "dest": ["AU", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 7 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "M"], "step": ["AI", "X"], "dest": ["IA", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "Z"], "step": ["IA", "T"], "dest": ["IA", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "N"], "step": ["AI", "C"], "dest": ["IA", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 6 } } },
	...
	expect(parseCerkeOnlineKia1Ak1(case3)).toEqual({
		...
		parsed_bodies: [
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 0, "prof": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "C"], "dest": ["AU", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "P"], "step": ["E", "C"], "dest": ["I", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "tam_move", "movement": { "type": "TamMove", "stepStyle": "StepsDuringLatter", "src": ["O", "Z"], "firstDest": ["Y", "Z"], "step": ["AI", "Z"], "secondDest": ["AU", "Z"] } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["I", "Z"], "dest": ["AI", "Z"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 1, "prof": 0 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "T"], "step": ["AU", "T"], "dest": ["AI", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 0 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "T"], "step": ["I", "N"], "dest": ["U", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 0, "infafterstep_success": false } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "T"], "step": ["AI", "N"], "dest": ["I", "C"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 7 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "X"], "step": ["AU", "X"], "dest": ["AI", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 3 }, "piece_capture": { "color": 0, "prof": 0 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "M"], "step": ["I", "X"], "dest": ["O", "M"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "X"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "T"], "step": ["I", "N"], "dest": ["U", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "T"], "step": ["I", "C"], "dest": ["A", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 9 } } },
			{ "type": "taxot", "hands": ["王"], "score": 5 },
			{ "type": "end_season" },
			{ "type": "season_ends", "season": 0 },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "L"], "step": ["I", "L"], "dest": ["U", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "X"], "step": ["AI", "Z"], "dest": ["Y", "T"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["U", "L"], "step": ["AI", "L"], "dest": ["AU", "L"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 2 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["IA", "K"], "step": ["AI", "K"], "dest": ["Y", "K"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "N"], "step": ["I", "N"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 2 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "K"], "step": ["I", "K"], "dest": ["E", "K"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 7 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "C"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "N"], "dest": ["AU", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "N"], "step": ["I", "N"], "dest": ["O", "N"] } }, "ciurl_and_capture": { "ciurl_event": { "water_entry_ciurl": 3 }, "piece_capture": { "color": 0, "prof": 2 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "T"], "step": ["I", "Z"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 0, "prof": 4 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "L"], "step": ["AU", "N"], "dest": ["AI", "N"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["A", "Z"], "step": ["A", "X"], "dest": ["E", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "M"], "step": ["E", "C"], "dest": ["E", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "C"], "step": ["I", "M"], "dest": ["U", "P"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "N"], "step": ["U", "X"], "dest": ["U", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": false } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["I", "N"], "dest": ["A", "K"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "N"], "step": ["U", "X"], "dest": ["U", "P"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": false } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["U", "X"], "dest": ["O", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 1, "water_entry_ciurl": 3 } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AI", "N"], "step": ["U", "X"], "dest": ["U", "C"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["O", "Z"], "step": ["AI", "C"], "dest": ["IA", "Z"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 9 } } },
			{ "type": "taxot", "hands": ["地心", "王", "獣"], "score": 15 },
			{ "type": "end_season" },
			{ "type": "season_ends", "season": 1 },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "M"], "step": ["I", "M"], "dest": ["U", "M"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "X"], "step": ["AI", "C"], "dest": ["Y", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["I", "C"], "dest": ["E", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "C"], "dest": ["AU", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "P"], "step": ["E", "C"], "dest": ["I", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["Y", "X"], "step": ["U", "M"], "dest": ["I", "C"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 1, "prof": 7 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["U", "M"], "step": ["AI", "M"], "dest": ["AI", "C"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 4, "infafterstep_success": true }, "piece_capture": { "color": 1, "prof": 7 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["E", "X"], "step": ["I", "C"], "dest": ["U", "X"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 3, "infafterstep_success": true } } },
			{ "type": "from_hopzuo", "movement": { "type": "NonTamMove", "data": { "type": "FromHop1Zuo1", "color": 1, "prof": 2, "dest": ["Y", "C"] } } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["I", "X"], "step": ["U", "X"], "dest": ["U", "C"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "X"], "dest": ["Y", "X"] } }, "ciurl_and_capture": { "ciurl_event": {} } },
			{ "type": "tam_move", "movement": { "type": "TamMove", "stepStyle": "StepsDuringLatter", "src": ["O", "Z"], "firstDest": ["U", "Z"], "step": ["I", "Z"], "secondDest": ["E", "Z"] } },
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcDst", "src": ["AI", "Z"], "dest": ["I", "Z"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 0, "prof": 0 } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["AU", "T"], "step": ["AI", "N"], "dest": ["Y", "T"] } }, "ciurl_and_capture": { "ciurl_event": { "stepping_ciurl": 2, "infafterstep_success": true } } },
			...
			{ "type": "normal_move", "movement": { "type": "NonTamMove", "data": { "type": "SrcStepDst", "src": ["O", "Z"], "step": ["I", "C"], "dest": ["A", "P"] } }, "ciurl_and_capture": { "ciurl_event": {}, "piece_capture": { "color": 0, "prof": 6 } } },
